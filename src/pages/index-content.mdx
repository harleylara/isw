...
The predictor (G):
- predicts a sequence of future end effector haptic measurements based on the robot executing actions
The estimator (F)
...
- [International Conference on Intelligent Robots and Systems (IROS)](https://www.ieee-ras.org/conferences-workshops/financially-co-sponsored/iros)

## 7.6 List of most important journals and magazines

Journals:
- [Science Robotics](https://www.science.org/journal/scirobotics)
- [Frontier](https://www.frontiersin.org/journals/robotics-and-ai)
